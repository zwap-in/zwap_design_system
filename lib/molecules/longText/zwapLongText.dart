...
class _ZwapLongTextState extends State<ZwapLongText> {
  ...
  Widget _getText() {
    ...
    return ZwapTextMultiStyle(
      texts: {
        flag ? (firstHalf + "...") : (firstHalf + secondHalf): TupleType(a: null, b: TupleType(a: ZwapTextType.body1Regular, b: ZwapColors.neutral600)),
        flag ? " ${widget.readMoreText}" : " ${widget.readLessText}": TupleType(a: recognizer, b: TupleType(a: ZwapTextType.body1SemiBold, b: ZwapColors.neutral700))
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    return new Container(
      ...
      child: secondHalf.isEmpty ? new ZwapText(
        text: firstHalf,
