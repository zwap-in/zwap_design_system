...
class ZwapExpansion extends StatefulWidget {
  ...
  /// Params is passed directly into the [Align].
  ///
  ...
  ///
  /// The internals of the expanded tile make use of a [Column] widget for
  /// [children], and the `crossAxisAlignment` Params is passed directly into the [Column].
  ///
  ...
  /// The color of the divider on Bottom
  final Color? bottomDividerColor;

  @override
  State<ZwapExpansion> createState() => _ExpansionTileStateCustom();
}

class _ExpansionTileStateCustom extends State<ZwapExpansion> with SingleTickerProviderStateMixin {
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    final Color borderBottomSideColor = _borderColor.value ?? ((widget.bottomDividerColor != null) ? widget.bottomDividerColor as Color : Colors.transparent);

    return Container(
      decoration: BoxDecoration(
        color: _backgroundColor.value ?? Colors.transparent,
        border: Border(
          top: BorderSide(color: borderBottomSideColor),
          bottom: BorderSide(color: borderBottomSideColor),
        ),
      ),
      child: Column(
  ...
  Widget build(BuildContext context) {
    ...
    widgetChildren.addAll(widget.children);
